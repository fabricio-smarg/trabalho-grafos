...
void lerEdges(int *edges, int size){
    ...
    */
    ...
    bool janelaTempo(informacao[], int tempoTotalGasto, int tempoNovaColeta){// origem e horario de serviço && janela de tempo (predendemos ir atualizando o tempo) 
    ...
    //    pelo mesmo veiculo. 
    bool capacidadeVeiculo(caminhao x, int novaCarga, informacao[], edgesVisitados [][], int coord1, int coord2){
